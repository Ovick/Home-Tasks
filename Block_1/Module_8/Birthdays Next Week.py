...
users = [
    {
        "name": "Anna-Sofiya",
        "birthday": datetime.date(1985, 9, 24)
    },
    {
        "name": "Viktoriya",
        "birthday": datetime.date(1985, 9, 25)
    },
    {
        "name": "Solomiya",
        "birthday": datetime.date(1990, 9, 27)
    },
    {
        "name": "Oleksandr",
        "birthday": datetime.date(1998, 9, 27)
    },
    {
        "name": "Mark",
        "birthday": datetime.date(2005, 9, 30)
    },
    {
        "name": "Bogdan",
